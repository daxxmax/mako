...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[3]  = { {  702000, HFPLL, 1, 0x1A }, 1150000, 1150000, 4 },
	...
	[4] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 5 },
	//[13] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 5 },
	//[5] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 5 },
	[5] = { { 1188000, HFPLL, 1, 0x2C }, 1150000, 1150000, 5 },
	[6] = { { 1350000, HFPLL, 1, 0x32 }, 1150000, 1150000, 5 },
	{ }
};
...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
	...
	{ 0, {   810000, HFPLL, 1, 0x1E }, L2(5),  1075000 },
...
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
	...
	{ 0, {   810000, HFPLL, 1, 0x1E }, L2(5),  1000000 },
...
static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
	...
	{ 0, {   810000, HFPLL, 1, 0x1E }, L2(5),   950000 },
